...
function copy(array) {
  //declare variable intent to name new array for array copy
  //defining new array value
  let bKuPoriginalFlavors = array.slice();
  // 'staging to print'
  return bKuPoriginalFlavors;
}
...
function is31Flavors(array) {
  //check that there are 31 array items

  if (array.length === 31) {
    // if processed as factual print affirmative boolean as confirmation
    return true;
  } else {
    //if processed as fictional print denial boolean as confirmation
    return false;
  }
}
